...
import { FileText, Calendar, User, Download, Eye, MoreVertical } from "lucide-react";
...
export function DocumentCard({
  ...
  const handleCardClick = () => {
    router.push(`/supervisor/document/${id}`);
  };
    ...
    >
      ...
      <div className="flex items-start justify-between mb-4 gap-4">
        ...
        <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex-shrink-0">
          <button
            onClick={(e) => handleActionClick(e, () => router.push(`/supervisor/document/${id}`))}
