...
export default function Dashboard() {
  ...
  const handleGenerateFullReport = async () => {
    if (!projectData) {
      alert(
        "No project data available to generate report. Please make sure you have a project assigned."
      );
      return;
    }
  ...
  const handleGenerateTaskList = async () => {
    if (!projectData || !projectData.milestones) {
      alert(
        "No tasks available to generate task list. Please make sure you have tasks in your project."
      );
      return;
    }
    ...
    <>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className=" text-gray-200 p-6 rounded-xl shadow-lg border border-gray-700">
            <div className="flex items-center gap-3 mb-4">
