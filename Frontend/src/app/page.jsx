...
export default function Home() {
  return (
    <div className="min-h-screen bg-gray-900 ">
      ...
      <Features />
      {/* CTA Section */}
      <section className="bg-gray-800 py-20 my-5 mx-10 rounded-3xl">
...
// Here's how to use the extracted colors:

// Old Color Class	New Color Class	Hex Value
// text-green-400	text-primary-400	#4ADE80
// bg-green-500	bg-primary-500	#22C55E
// text-[#F6F6F6]	text-gray-100	#F6F6F6
// bg-gray-800	bg-gray-800	#1F2937
// bg-gray-900	bg-gray-900	#111827
// text-gray-300	text-gray-400	#9CA3AF
// border-gray-600	border-gray-600	#4B5563
